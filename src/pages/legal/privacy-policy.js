      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="text-lg max-w-7xl mx-auto">
          ...
          <p className="mt-8 text-xl text-gray-00 leading-8 font-content">
            ...
            changes. This policy is effective from 3rd Dec 2019
          </p>
          ...
          <div className="mt-6 max-w-7xl text-gray-800 mx-auto">
            ...
            <p className="mt-4 text-lg font-content">
              ...
              send you promotional information about third parties which we
              think you may find interesting if you tell us that you wish this
              to happen. We undertake not to disclose the information provided
              by the customer to any person unless such action is necessary to
              the extent required by law and for regulatory purposes. If you
              believe that any information we are holding on you is incorrect or
              incomplete, please write to or email us as soon as possible, at
