          ...
          <div className='relative mx-auto mt-10 max-w-7xl md:bg-white'>
            <div className='lg:grid lg:grid-cols-2 lg:gap-6'>
              <div className='text-gray-800'>
                <span className='mt-2 block text-center font-heading text-3xl font-extrabold leading-8 tracking-tight text-gray-800 underline underline-offset-4 sm:text-2xl'>
                  Disclaimer
                </span>
