...
export const getStaticPaths = async () => {
  ...
  return {
    paths: data.tests.map(({ slug }) => ({ params: { slug } })),
    fallback: true,
  };
};
  ...
  function addReviewJsonLd() {
    return {
      __html: `{
        ...
        "description": "${test?.content?.text.slice(0, 160)}",
        "brand": {
          "@type": "Brand",
  ...
  function addProductJsonLd() {
    return {
      __html: `{
        ...
        "offers": {
        "@type": "AggregateOffer",
        "url": "https://www.garbhagudi.com/tests/${test?.slug}",
        "priceCurrency": "INR",
        "lowPrice": "90000",
        "highPrice": "280000"
        },
      ...
      __html: `{
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": "3",
              "name": "${test?.title}",
              "item": "https://www.garbhagudi.com/clinics/${test?.slug}"
            }
          ]
        }`,
    };
  ...
  return (
    <div>
      <Head>
        ...
        <title>{`${test?.metaTitle || test?.title}`}</title>
        <meta
          name='title'
          content={`${test?.metaTitle || test?.title}`}
        />
        <meta
          name='description'
          content={
            test?.metaDescription || test?.content?.text.slice(0, 160)
          }
        />
        ...
        {test?.slug === 'laparoscopy-treatment-in-bangalore' && (
          <script
            type='application/ld+json'
        ...
        <meta
          property='og:title'
          content={`${test?.title} | GarbhaGudi IVF Centre`}
        />
        <meta property='og:site_name' content='GarbhaGudi IVF Centre' />
        <meta property='og:url' content='https://garbhagudi.com' />
        <meta
          property='og:description'
          content={test?.content?.text.slice(0, 160)}
        />
        ...
        />
        {test?.image?.url && (
         <meta name='twitter:image' content={test?.image.url} />
        )}
      </Head>
      <BreadCrumbs
        link1='/tests'
        ...
        <div className='relative px-4 sm:px-6 lg:px-8'>
          <div className='mx-auto max-w-7xl'>
            ...
            <div className='text-gray-800 dark:text-gray-200'>
              <RichText content={test?.content?.raw?.children} />
            </div>
            <div>
              <Share pinmedia={test?.image?.url} />
            </div>
          </div>
        </div>
      </div>
