...
export const getStaticPaths = async () => {
  ...
  return {
    paths: data.clinics.map(({ slug }) => ({ params: { slug } })),
    fallback: true,
  };
};
  ...
  function addReviewJsonLd() {
    return {
      __html: `{
        ...
        "description": "${clinic?.content?.text.slice(0, 160)}",
        "brand": {
          "@type": "Brand",
  ...
  function addProductJsonLd() {
    return {
      __html: `{
        ...
        "offers": {
        "@type": "AggregateOffer",
        "url": "https://www.garbhagudi.com/clinics/${clinic?.slug}",
        "priceCurrency": "INR",
        "lowPrice": "90000",
        "highPrice": "280000"
        },
      ...
      __html: `{
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": "2",
              "name": "treatments",
              "item": "https://www.garbhagudi.com/clinics/"
            },
            {
              "@type": "ListItem",
              "position": "3",
              "name": "${clinic?.title}",
              "item": "https://www.garbhagudi.com/clinics/${clinic?.slug}"
            }
          ]
        }`,
    };
  ...
  return (
    <div>
      <Head>
        ...
        <title>{`${clinic?.metaTitle || clinic?.title}`}</title>
        <meta
          name='title'
          content={`${clinic?.metaTitle || clinic?.title}`}
        />
        <meta
          name='description'
          content={
            clinic?.metaDescription || clinic?.content?.text.slice(0, 160)
          }
        />
        ...
        {clinic?.slug === 'laparoscopy-treatment-in-bangalore' && (
          <script
            type='application/ld+json'
        ...
        <meta
          property='og:title'
          content={`${clinic?.title} | GarbhaGudi IVF Centre`}
        />
        <meta property='og:site_name' content='GarbhaGudi IVF Centre' />
        <meta property='og:url' content='https://garbhagudi.com' />
        <meta
          property='og:description'
          content={clinic?.content?.text.slice(0, 160)}
        />
        <meta property='og:type' content='website' />
        {clinic?.image?.url && (
           <meta property='og:image' content={clinic?.image.url} />
        )}
        ...
        />
        {clinic?.image?.url && (
         <meta name='twitter:image' content={clinic?.image.url} />
        )}
      </Head>
      <BreadCrumbs
        link1='/clinics'
        ...
        <div className='relative px-4 sm:px-6 lg:px-8'>
          <div className='mx-auto max-w-7xl'>
            ...
            {clinic?.image?.url && (
               <figure>
                  <img
                   ...
                   alt={clinic?.imageAlt || clinic?.title}
                   width={1310}
                   height={873}
                  />
                </figure>
            ...
            <div className='text-gray-800 dark:text-gray-200'>
              <RichText content={clinic?.content?.raw?.children} />
            </div>
            <div>
              <Share pinmedia={clinic?.image?.url} />
            </div>
          </div>
        </div>
      </div>
