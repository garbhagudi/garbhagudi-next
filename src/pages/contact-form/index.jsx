...
const IndexPage = () => {
  ...
  return (
    <>
      <div
        className="max-w-7xl mx-auto flex items-center justify-center crmWebToEntityForm"
      ...
      >
        ...
        >
          ...
          <input
            ...
            name="LDTuvid"
          ></input>
          <div className="w-full max-w-2xl px-5 py-10 m-auto mt-10 bg-white rounded-lg shadow-2xl">
              ...
              <div className="col-span-2">
                <div className=" relative ">
                  <input
                    ...
                    name="Last Name"
                    maxLength={80}
                    className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-brandPink2 focus:border-transparent"
