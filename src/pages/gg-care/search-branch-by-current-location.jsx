...
const SearchByCurrentLocation = () => {
  return (
    <div class="w-full h-screen flex items-center flex-col justify-center text-3xl lg:text-4xl font-heading">
      <div>Coming Soon...</div>
      <div className="mt-4 text-xl font-content px-3 py-2 bg-brandPink2 text-white font-semibold rounded-lg hover:bg-brandPink">
        <Link href={"/gg-care"}>Go back</Link>
      </div>
    </div>
  );
};

export default SearchByCurrentLocation;
