...
export const landingNextZohoFormActionUrl =
  process.env.NEXT_PUBLIC_LANDING_NEXT_ZOHO_FORM_ACTION_URL?.trim() || DEFAULT_ACTION;
...
export const landingNextZohoFormLeadSubSourceFieldName =
  process.env.NEXT_PUBLIC_LANDING_NEXT_ZOHO_FORM_FIELD_LEAD_SUB_SOURCE?.trim() || 'Lead_Sub_Source';
 ...
 */
export const landingNextRecaptchaSiteKey = process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY?.trim();
