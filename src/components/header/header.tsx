...
const Nav = () => {
  ...
  return (
    <div
      className={`sticky top-0 z-50 bg-white bg-[url(https://res.cloudinary.com/garbhagudiivf/image/upload/v1714747968/Mothers-Day-Theme_1_-min_sre2qf.webp)] bg-auto lg:bg-cover bg-no-repeat dark:bg-gray-800 shadow-xl dark:border-b dark:border-gray-600 bg-opacity-70 dark:bg-opacity-70 backdrop-blur-2xl`}
    >
