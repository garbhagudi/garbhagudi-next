                  ...
                  {Resources.map((item) => (
                    <Link key={item.name} href={item.href} passHref className='group'>
                      <div
                        ...
                        role='none'
                      >
                        <div className='flex h-10 w-10 flex-shrink-0 items-center justify-center text-white transition-all duration-150 ease-in-out dark:grayscale dark:group-hover:grayscale-0 sm:h-12 sm:w-12 rounded-md'>
                          <Image
                            src={item.icon}
                            alt={item.name}
                            loading='lazy'
