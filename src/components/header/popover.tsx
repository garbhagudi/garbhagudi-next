        ...
        <>
          ...
          >
            <Popover.Panel className='absolute z-10 px-4 mt-3 lg:mt-7 transform -translate-x-1/2 w-screen max-w-xl left-1/2 sm:px-0 lg:max-w-xl'>
              <div className='overflow-hidden shadow-lg rounded-lg ring-1 ring-black ring-opacity-5 bg-white dark:bg-gray-800'>
                <Tab.Group>
                    ...
                    <Tab
                      className={({ selected }) =>
                        classNames(
                          ...
                          'focus:outline-none',
                          selected
                            ? 'bg-gray-100 dark:bg-gray-700 ring-2 ring-brandPink2 shadow'
