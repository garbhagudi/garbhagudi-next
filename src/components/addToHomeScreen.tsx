...
const AddToIosSafari = dynamic(() => import('./browserPrompt/addToIosSafari'), {
  loading: () => <ModuleLoading />,
});
const AddToMobileChrome = dynamic(
  () => import('./browserPrompt/AddToMobileChrome'),
  {
    loading: () => <ModuleLoading />,
  }
);
const AddToMobileFirefox = dynamic(
  () => import('./browserPrompt/AddToMobileFirefox'),
  {
    loading: () => <ModuleLoading />,
  }
);
const AddToMobileFirefoxIos = dynamic(
  () => import('./browserPrompt/AddToMobileFirefoxIos'),
  {
    loading: () => <ModuleLoading />,
  }
);
const AddToMobileChromeIos = dynamic(
  () => import('./browserPrompt/AddToMobileChromeIos'),
  {
    loading: () => <ModuleLoading />,
  }
);
const AddToSamsung = dynamic(() => import('./browserPrompt/AddToSamsung'), {
  loading: () => <ModuleLoading />,
});
const AddToOtherBrowser = dynamic(
  () => import('./browserPrompt/AddToOtherBrowser'),
  {
    loading: () => <ModuleLoading />,
  }
);
