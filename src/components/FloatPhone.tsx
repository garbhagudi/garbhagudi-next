...
const FloatPhone = ({ presentation }: { presentation?: boolean }) => {
  ...
  return (
    <>
      <div
        className={`${
          presentation && 'fixed left-0 top-20'
        } z-10 grid w-full animate-shake cursor-pointer grid-cols-2 items-center justify-center bg-gg-500 px-2 font-content font-bold text-white transition-opacity ease-in hover:opacity-100 md:hidden`}
      >
      ...
      <Dialog open={isOpen} as='div' className='relative z-10 focus:outline-none' onClose={close}>
        ...
        <div className='fixed inset-0 z-10 w-screen overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center px-3 pt-8'>
            <DialogPanel
              transition
              className='max-w-md rounded-xl bg-gray-800 pb-4 shadow-[0_0_15px_5px_rgba(0,0,0,0.3)] transition-shadow duration-300 ease-out hover:shadow-[0_0_25px_10px_rgba(0,0,0,0.5)] data-[closed]:scale-95 data-[closed]:opacity-0'
            >
              ...
              <div className='px-0'>
                <div className='flex justify-center'>
                  <div className='mx-5 mt-5 rounded-md bg-brandPink px-4 py-1 text-center text-[13px] font-semibold text-white shadow-sm'>
