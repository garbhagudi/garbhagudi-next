  ...
  return (
    <>
      <div
        ...
        className={
          activeIndex === index
            ? `text-md mt-3 flex w-full items-center justify-between rounded-t-lg bg-brandPink3 px-3 py-2 font-dmSans text-white transition-all duration-500 ease-in-out hover:cursor-pointer sm:px-6 xl:text-xl`
      ...
      >
        {activeIndex === index && (
          <div className='shadow-3xl rounded-b-lg border-2 border-brandPink3 p-4'>{children}</div>
        )}
      </Transition>
    </>
  );
