    ...
    <section className='px-[5%] py-[90px]'>
      ...
      <div className='mt-11 grid grid-cols-1 gap-6 lg:grid-cols-2'>
        {doctors.map((d) => (
          ...
          >
            <div className='flex h-[52px] w-[52px] shrink-0 items-center justify-center rounded-[10px] bg-gradient-to-br from-[#1B5E20] to-[#43A047] text-[1.3rem] font-bold text-white'>
              {d.av}
            </div>
            <div>
