      ...
      <div>
        <section className='relative overflow-hidden bg-cover bg-right bg-no-repeat sm:bg-center'>
          ...
          <div className='relative mx-auto max-w-screen-xl px-4 py-28 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8'>
            <div className=' max-w-lg md:max-w-2xl  sm:text-left mt-24 lg:mt-0'>
              ...
              <div className='mt-8 flex flex-wrap items-center gap-4 font-figtree text-base font-semibold'>
                ...
                <Link
                  ...
                  className='block text-center scroll-smooth rounded-[10px] border-2 bg-[#1D1D1D] px-4 py-2 font-content text-lg text-white shadow hover:opacity-90 focus:outline-none focus:ring dark:text-white sm:w-auto'
                >
                  Take a Quiz
                </Link>
              </div>
