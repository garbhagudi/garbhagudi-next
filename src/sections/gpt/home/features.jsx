...
//         <h2 className='mt-2 text-center font-dmSans text-2xl font-bold text-brandDark sm:text-3xl'>
...
//                       <h3 className='mt-3 font-dmSans text-base font-semibold tracking-tight text-brandDark md:text-lg'>
//                         {feature?.name}
//                       </h3>
...
import React from 'react';
import { Percent, Building2, Stethoscope, IndianRupee, Leaf, TestTube2 } from 'lucide-react';
                ...
                <div className='shadow-3xl h-full overflow-hidden rounded-lg transition-all hover:scale-105'>
                  <div className='grid h-full grid-cols-6'>
                    ...
                    <div className='col-span-5 border-2 border-brandPink px-2 py-4'>
                      <h3 className='mt-1 font-dmSans text-lg font-semibold'>{feature.name}</h3>
