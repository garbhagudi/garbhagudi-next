...
const TreatmentOptions = ({ branch }) => {
  return (
    <div className='container mx-auto lg:max-w-7xl'>
      <h2 className='px-2 pb-16 text-center font-dmSans text-2xl font-bold text-brandDark sm:text-3xl lg:pb-20'>
        ...
        {treatmentOptionsData?.map((items) => (
          ...
          >
            ...
            <div className='flex flex-col items-center justify-center py-2'>
              <div className='pb-2 text-center font-dmSans text-base font-bold text-brandDark md:text-xl'>
                {items?.treatent}
              </div>
