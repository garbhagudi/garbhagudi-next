...
import { featuredCarouselVideoIds } from 'data/gpt/garbhagudiTestimonialVideos';
  ...
  return (
    <div className='bg-brandPurple'>
      <div className='mx-auto max-w-7xl py-8'>
        <h3 className='flex items-center justify-center text-center font-dmSans text-2xl font-bold text-white sm:text-3xl lg:text-4xl'>
