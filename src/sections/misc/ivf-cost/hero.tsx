  ...
  return (
    <div className=''>
      <div className='mx-auto max-w-7xl'>
        <h1 className='text-3xl lg:text-5xl text-center font-heading font-bold text-transparent bg-clip-text bg-gradient-to-r from-gg-500 dark:from-gray-200 to-brandPurpleDark dark:to-gray-200 py-10 lg:py-16'>
          What is the Cost of IVF Treatment in Bangalore ?
        </h1>
        <div className='font-content max-w-7xl mx-auto relative px-3 text-gray-800 dark:text-gray-200'>
          <div>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 font-semibold'>
              <div className=' mt-8 flex flex-col items-start justify-start max-w-lg'>
                ...
                <div className='space-x-3'>
                  <button className='text-lg px-3 py-2 border dark:border-gray-600 mt-4 rounded-lg bg-brandPurpleDark dark:bg-gray-500 dark:hover:bg-brandPurpleDark/90 text-white hover:bg-opacity-80 font-bold mx-auto lg:mx-0'>
