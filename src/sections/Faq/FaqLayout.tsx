  ...
  return (
    <>
      <div
        ...
        className="flex w-full justify-between items-center px-3 sm:px-6 py-3 mt-3 rounded-xl text-brandDark bg-brandDark bg-opacity-20 hover:bg-opacity-80 hover:text-white hover:cursor-pointer"
      >
