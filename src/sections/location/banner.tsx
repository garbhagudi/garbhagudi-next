...
const Banner = ({ branchTitle }) => {
  ...
  return (
    <div>
      <div className='bg-[url(https://ap-south-1.graphassets.com/ATvkR6mxuRke4HGT9LQrhz/cms8vb8pz586107pldfljrjaq)] bg-cover bg-right bg-no-repeat shadow-2xl sm:bg-center'>
