...
export const ivfCentreFaqs = [
  {
    id: 1,
    question: 'Which is the best IVF centre in Davanagere?',
    answer:
      'GarbhaGudi IVF Centre is a trusted fertility hospital in Davanagere, with an in-house IVF lab and an experienced team of fertility specialists. The right centre for you is one with proven experience, transparent guidance and care close to where you live — all of which GarbhaGudi offers.',
  },
  {
    id: 2,
  ...
  {
    id: 3,
    question: 'Where is the GarbhaGudi IVF centre located in Davanagere?',
    answer:
      'GarbhaGudi has a dedicated fertility centre in Davanagere so care stays accessible close to home. You can view the branch details in the locations section of this page.',
  },
  {
    id: 4,
    question: 'How do I book an appointment at GarbhaGudi IVF Centre, Davanagere?',
    answer:
      'You can book a free consultation by filling the enquiry form on this page, calling +91 91089 10832, or messaging us on WhatsApp. Our team will help you schedule a visit at our Davanagere centre.',
  },
  {
    id: 5,
    question: 'Does GarbhaGudi treat complex or previously failed fertility cases?',
    answer:
      'Yes. Our centre is equipped to handle challenging cases, including couples who have had unsuccessful cycles elsewhere. A specialist reviews your history and recommends a personalised treatment plan.',
  },
  {
    id: 6,
