...
/**
 * Hero for the Davanagere "IVF Centre / Hospital / Clinic" campaign.
 *
 * Quality Score intent: the H1 and first line mirror the keyword theme
 * exactly (IVF centre / fertility hospital in Davanagere) so the searcher
...
import {
  ...
  PHONE_TEL,
  waLink,
} from 'sections/ivf-center-davanagere/constants';

const proofPoints = [
  '15,000+ babies delivered since 2011',
  'Trusted fertility centre in Davanagere',
    ...
    >
      ...
      <div className='mx-auto grid max-w-7xl items-center gap-10 px-4 pb-4 pt-10 sm:px-6 md:pb-16 lg:grid-cols-2 lg:gap-12 lg:px-8 lg:pb-24 lg:pt-16'>
        ...
        <div className='order-last lg:order-none'>
          ...
          >
            Best IVF Centre &amp; Fertility Hospital in Davanagere
          </h1>
          ...
          <p className='mt-4 font-content text-xs text-gray-500'>
            Free first consultation · Confidential · Davanagere-based fertility specialists
          </p>
        </div>
