...
const NutritionSection = ({ title, firstColLabel, rows }: NutritionSectionProps) => (
  <div>
    <h3 className='mb-4 font-heading text-lg font-bold text-gray-900 dark:text-white sm:text-xl'>
      {title}
    </h3>
    ...
    <div className='hidden overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 sm:block'>
      <div className='overflow-x-auto'>
        <table className='min-w-full divide-y divide-gray-200 font-content text-sm dark:divide-gray-700'>
          <thead>
    ...
    <div className='space-y-3 sm:hidden'>
      {rows.map((row) => (
        ...
        >
          <p className='mb-3 font-heading text-sm font-bold text-gray-900 dark:text-white'>
            {row.name}
          </p>
          <div className='space-y-2'>
            ...
            <div>
              ...
              <p className='font-content text-xs text-gray-700 dark:text-gray-300'>
                {row.benefits}
              </p>
            </div>
            <div>
              ...
              <p className='font-content text-xs text-green-700 dark:text-green-400'>
                {row.indications}
              </p>
            </div>
            <div>
              <p className='text-xs font-semibold uppercase tracking-wide text-red-500'>Cautions</p>
              <p className='font-content text-xs text-red-600 dark:text-red-400'>
                {row.contraindications}
              </p>
            </div>
          </div>
