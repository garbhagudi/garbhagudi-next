...
const Testimonial = () => {
  ...
  return (
    <section className='overflow-hidden bg-gradient-to-tr from-brandPink3/70 via-brandPurple/50 to-purple-100 py-8 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 sm:mb-6'>
