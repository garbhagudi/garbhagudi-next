    ...
    <div className='container mx-auto'>
      ...
      <div className='grid grid-cols-1 gap-x-3 gap-y-16 px-2 pb-10 lg:grid-cols-4 lg:gap-16 lg:pb-16'>
        {Data.map((items) => (
          <div
            key={items?.id}
            className='flex flex-col items-center justify-between rounded-2xl border border-brandPink4 font-content transition-all duration-300 hover:-translate-y-2 hover:bg-pink-50 hover:shadow-2xl'
          >
