...
const Testimonial = () => {
  ...
  return (
    <section className='bg-gradient-to-tr from-brandPink3/70 dark:from-gray-800 via-brandPurple/50 dark:via-gray-700 to-purple-100 dark:to-gray-800 overflow-hidden py-8'>
