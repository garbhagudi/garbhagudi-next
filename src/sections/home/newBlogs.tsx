          ...
          {posts?.map((post) => (
            ...
            >
              <div className='mt-6 flex items-center justify-center'>
                <div
                  className='relative w-[400px] h-64 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg drop-shadow-lg hover:drop-shadow-2xl hover:shadow-2xl transition duration-300 ease-in-out'
                ...
                >
                  ...
                  <div className='relative w-full h-full px-4 sm:px-6 lg:px-4 flex justify-center items-center'>
                    <h3 className='text-center'>
                      <div className='text-white text-xl font-bold text-center font-content drop-shadow-2xl'>
                        {post.title}
                      </div>
                    </h3>
                  </div>
